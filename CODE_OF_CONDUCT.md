...
may be reported by contacting the project maintainers via
[GitHub Issues](https://github.com/hirusha-adi/buttplug-go/issues). All complaints will be reviewed and investigated
...
Buttplug ecosystem, all contributors and participants should be
of provable legal age.

Working on [buttplug-go](https://github.com/hirusha-adi/buttplug-go) may at
...
have not been met, they should contact the project maintainers via
[GitHub Issues](https://github.com/hirusha-adi/buttplug-go/issues).

# Moderation

These are the policies for upholding our community's standards of
conduct. If you feel that a thread needs moderation, please contact
the [project maintainers](https://github.com/hirusha-adi/buttplug-go/issues).
...
[buttplug-go](https://github.com/hirusha-adi/buttplug-go) venues,
including the repository, issue tracker, pull requests, and
discussions. For other projects adopting
